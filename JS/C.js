...
var number=JSON.parse(historial);
for(var x=0;x<historial.length;x++)//recorriendo el JSON
{
    //Ingresando los datos a la tabla
    fila.innerHTML+='<tr> <td>'+lista.datos[x].Producto+'</td><td>'+ lista.datos[x].Precio ;

     document.getElementById("Tota").innerHTML="Total: "+total;    
}
